...
const projectOverviewCardsData = [
  ...
  },
  {
    ...
    name: "Spotify Clone",
    description:
      "It uses the spotify web api to fetch songs data. You can search for songs and listen to them in the embedded music player in real time.",
  },
  {
    tags: ["React + Redux + Youtube API"],
    name: "Youtube Clone",
    description:
      "It uses the youtube data api to fetch data. You can search for videos and watch them in the video player in real time.",
  },
  {
  ...
  //   name: "Get to know me",
  //   description:
  //     "This is a CLI app hosted on repl. A fun quiz where you can get to know more about me.",
  // },
  // {
  ...
  // },
  // {
  //   tags: ["React", "React Redux", "PokeAPI"],
  ...
  // },
  // {
  //   tags: ["Flask", "React", "React Redux", "PostgreSQL"],
  //   name: "Easy Notes",
  //   description:
